      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
            Transparent Bank Account Verification API Pricing – AOPAY
          </h2>

          {/* Description */}
          <p className="text-lg text-gray-600 leading-relaxed">
            Simple, transparent pricing with no hidden fees. Pay only for
            successful account verifications with volume discounts available for
            fintech companies and payment processors handling high volumes.
          </p>
