...
const walletMonetizationContent = [
  {
    title: "AOPAY: Monetize & Scale Your Wallet Platform",
    description:
      "Unlock revenue opportunities and optimize profitability with flexible fee structures, advanced analytics, and loyalty programs built for modern digital wallet platforms.",
    points: [
      {
        ...
        imgSrc:
          "/assets/EWallet/Monetize Your Wallet Platform/Flexible Revenue Models.png",
      },
      {
        ...
        imgSrc:
          "/assets/EWallet/Monetize Your Wallet Platform/Customizable Fee Management.png",
      },
      {
        ...
        imgSrc:
          "/assets/EWallet/Monetize Your Wallet Platform/Advanced Analytics & Reporting.png",
      },
      {
        ...
        imgSrc:
          "/assets/EWallet/Monetize Your Wallet Platform/Loyalty & Engagement Features.png",
      },
    ],
...
export const EWalletMonetizationSection = () => {
  return (
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 flex items-center justify-center rounded-full bg-green-100">
                      <img src = {point.imgSrc} alt = {point.heading}  className="text-green-600 w-5 h-5" />
                    </div>
